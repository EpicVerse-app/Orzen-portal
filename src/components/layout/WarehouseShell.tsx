...
export default function WarehouseShell({ user, children, primaryColor, sidebarColor, logoUrl }: Props) {
  ...
  useEffect(() => {
    router.prefetch('/dashboard/warehouse')
    router.prefetch('/dashboard/warehouse/notifications')
  }, [])
  ...
  const NAV = [
    { href: '/dashboard/warehouse',               label: 'Dashboard',     icon: LayoutDashboard, exact: true,  badge: 0 },
    { href: '/dashboard/warehouse/notifications',  label: 'Notifications', icon: Bell,            exact: false, badge: unreadCount },
  ]
          ...
          {showNotifs && (
            <div className="animate-dropdown absolute right-0 top-11 w-72 bg-white rounded-xl shadow-xl border border-gray-100 z-50 overflow-hidden">
              ...
              <div className="border-t border-gray-100 px-4 py-2">
                <Link href="/dashboard/warehouse/notifications" onClick={() => setShowNotifs(false)}
          ...
          <div className="px-3 py-3 space-y-2" style={{ borderTop: '1px solid rgba(255,255,255,0.08)' }}>
            <div className="flex items-center gap-3 px-2 py-1">
              ...
              <div className="min-w-0">
                ...
                <p className="text-xs" style={{ color: 'rgba(255,255,255,0.4)' }}>Warehouse</p>
              </div>
            </div>
            <button
              onClick={handleLogout}
