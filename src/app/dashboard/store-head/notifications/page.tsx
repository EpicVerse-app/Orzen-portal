...
import { Bell, CheckCircle, XCircle, Package, Truck, Clock, ShieldCheck } from 'lucide-react'
    ...
    <div className="px-4 sm:px-6 py-5 max-w-2xl mx-auto">
      ...
      <div className="flex items-center gap-3 mb-6">
        <div className="w-10 h-10 rounded-xl flex items-center justify-center shrink-0"
          style={{ backgroundColor: '#57043918' }}>
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-start justify-between gap-2">
                    ...
                    {!n.is_read && (
                      <span className="w-2 h-2 rounded-full shrink-0 mt-1.5" style={{ backgroundColor: '#570439' }} />
                    )}
                  </div>
