...
const BG_URL = process.env.NEXT_PUBLIC_ORZEN_BG_URL ||
  'https://muaqpangtwibnlmtjahn.supabase.co/storage/v1/object/sign/Orzen%20Flow/Background.png?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV8zNzBlM2JiYS01Nzg5LTRmNDQtOTMyNS00OTA1MGY3NWFlYjYiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJPcnplbiBGbG93L0JhY2tncm91bmQucG5nIiwic2NvcGUiOiJkb3dubG9hZCIsImlhdCI6MTc4MjEwNTg1NiwiZXhwIjoyMDk3NDY1ODU2fQ.VbSvu_EOzGf-b_U0PqrWl_v__VlofbA3YkVUsYcNQMo'
            ...
            <div className="flex-1 flex items-center justify-center overflow-hidden">
              {LOGO_URL ? (
                ...
                <div className="flex flex-col items-center justify-center gap-3 select-none">
                  <div className="text-4xl font-bold tracking-widest" style={{ color: '#D4B276', fontFamily: 'Georgia, serif', letterSpacing: '0.2em' }}>
                    ORZEN
                  </div>
                  <div className="text-lg font-semibold tracking-[0.4em]" style={{ color: '#B18850' }}>
                    FLOW
                  </div>
                  <div className="w-16 h-px mt-1" style={{ backgroundColor: '#B18850' }} />
                </div>
              )}
            </div>
